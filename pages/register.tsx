        ...
        <TempalteLogin>
            ...
            <div className="w-full">
                <Form onFinish={onFinish} className=' space-y-8'>
                    ...
                    <Form.Item label='' name="phoneNumber" className='mb-0' rules={[{ pattern:  /^\d{10,11}$/, message: 'Invalid phonenumber' }]}>
                        <div className="flex items-center m-0 space-x-6">
                    ...
                    <Form.Item label='' name="email" className='mb-0' rules={[{ pattern:  /^[^\s@]+@st\.usth\.edu\.vn$/, message: 'Invalid email' }]}>
                        <div className="flex items-center m-0 space-x-6">
                    ...
                    <Form.Item label="" name="password"
                        rules={[
                            ...
                            { pattern: /^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9]).{8,20}$/, message: 'Password must contain at least 8 characters including 1 capital letter and 1 number' }
                        ]}>
