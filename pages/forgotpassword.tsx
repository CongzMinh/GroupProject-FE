...
export default function Login() {
    ...
    const onFinish = async (values: any) => {
        try {
            ...
            const response = await fetch('http://localhost:8001/auth/email/forgot-password', {
                method: 'POST',
                headers: {
    ...
    return (
        <TempalteLogin>
            ...
            <Image src={logo} height='250px' className='object-scale-down'></Image>
                <div className="text-zinc-800 text-[40px] font-['Montserrat Alternates'] mt-10">FORGOT PASSWORD</div>
            ...
            <div className="w-full">
                <Form onFinish={onFinish} className='flex flex-col space-y-10'>
                    ...
                    <Form.Item>
                            <ButtonCustom type='primary' htmlType='submit'>Send OTP</ButtonCustom>
                    </Form.Item>
                </Form>
            </div>
        </TempalteLogin>
